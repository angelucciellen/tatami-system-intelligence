...
## 18. PHASE B BUILD-OUT TO DO LIST

*Added v1.26. Master roadmap for all systems, layers, and integrations required to reach Phase B readiness. Reference for next chat startup.*

### Five Major Systems:

| System | Purpose | Status | ETA |
|---|---|---|---|
| Webhook Infrastructure | Auto-capture OHLC + engine states | Designed, ready to build | Week 1 |
| Parallel Tagging Workflow | GC auto, NQ manual, anomaly review | Designed, execution-ready | Week 1–8 |
| Narrative Audit Engine | Narrative acceptance vs. price | Designed, metrics needed | Week 2–3 |
| Behavioral Pressure Meter | Behavioral force classification | Designed, formulas needed | Week 3–4 |
| Macro Intelligence Validator | Brief validation vs. COT + IV + data | Designed, API integration needed | Week 2–3 |

### Integration Points:

All five systems feed into enhanced webhook payload:
```json
{
  "time": "...",
  "ohlc": {...},
...
This complete payload feeds Phase C2 analyzer for conditional rule generation.

### Phase B Success Criteria (Week 8):
- 1,000–1,200 GC events (webhook)
- 300–400 NQ events (manual)
...
### Timeline:
- Week 1: Webhook setup + backfill
- Weeks 2–4: Narrative + Pressure + Validator frameworks
- Weeks 5–7: Integration + testing
- Week 8: Phase B readiness decision

---

## 19. QUICK REFERENCE — Next Chat Startup

**When starting new session, ask:**
```
"Claude, Phase B build-out status?"
...
**All sections 1–19 locked. Single source of truth. Ready for GitHub upload.**

**Last Updated:** June 18, 2026  
**Owner:** Ellen Angelucci  
**Next Update:** Weekly Friday EOW or after Phase B checkpoint
