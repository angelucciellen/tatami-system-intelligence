...
**Version:** 1.10 | **Last Updated:** 2026-05-31 | **Rubric:** v2
...
| Field | Value |
|---|---|
| File | vx_replay_tagger_v4.html |
| Hosted | https://vxreplaytagger--Kairos-a.replit.app |
| Version | v4 — active for Batch 4+ |
| New in v4 | `rail_zone` · `htf_rail_align` · `zone_diversity` · `cascade` · `mae_atr` · Starting ID field |
| New in v3 | Starting ID field (v3 superseded by v4) |
